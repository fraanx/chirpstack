...
goog.exportSymbol('proto.gw.XssModulationConfig', null, global);
goog.exportSymbol('proto.gw.XssModulationInfo', null, global);
/**
 ...
 * @constructor
 */
proto.gw.XssModulationInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.gw.XssModulationInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gw.XssModulationInfo.displayName = 'proto.gw.XssModulationInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.gw.XssModulationConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.gw.XssModulationConfig.repeatedFields_, null);
};
goog.inherits(proto.gw.XssModulationConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.gw.XssModulationConfig.displayName = 'proto.gw.XssModulationConfig';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.gw.Modulation.oneofGroups_ = [[3,4,5,6]];
...
proto.gw.Modulation.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    xss: (f = msg.getXss()) && proto.gw.XssModulationInfo.toObject(includeInstance, f)
  };
...
proto.gw.Modulation.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new proto.gw.XssModulationInfo;
      reader.readMessage(value,proto.gw.XssModulationInfo.deserializeBinaryFromReader);
      msg.setXss(value);
      break;
    default:
      reader.skipField();
...
proto.gw.Modulation.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.gw.XssModulationInfo.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional XssModulationInfo xss = 6;
 * @return {?proto.gw.XssModulationInfo}
 */
proto.gw.Modulation.prototype.getXss = function() {
  return /** @type{?proto.gw.XssModulationInfo} */ (
    jspb.Message.getWrapperField(this, proto.gw.XssModulationInfo, 6));
};


/**
 * @param {?proto.gw.XssModulationInfo|undefined} value
 * @return {!proto.gw.Modulation} returns this
*/
proto.gw.Modulation.prototype.setXss = function(value) {
  return jspb.Message.setOneofWrapperField(this, 6, proto.gw.Modulation.oneofGroups_[0], value);
};
 ...
 * @return {!proto.gw.Modulation} returns this
 */
proto.gw.Modulation.prototype.clearXss = function() {
 ...
 * @return {boolean}
 */
proto.gw.Modulation.prototype.hasXss = function() {
 ...
 * @const
 */
proto.gw.UplinkTxInfoLegacy.oneofGroups_ = [[3,4,5,6]];
...
proto.gw.UplinkTxInfoLegacy.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    xssModulationInfo: (f = msg.getXssModulationInfo()) && proto.gw.XssModulationInfo.toObject(includeInstance, f)
  };
...
proto.gw.UplinkTxInfoLegacy.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      var value = new proto.gw.XssModulationInfo;
      reader.readMessage(value,proto.gw.XssModulationInfo.deserializeBinaryFromReader);
      msg.setXssModulationInfo(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.gw.UplinkTxInfoLegacy.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getXssModulationInfo();
  if (f != null) {
    writer.writeMessage(
      6,
      f,
...
/**
 * optional XssModulationInfo xss_modulation_info = 6;
 * @return {?proto.gw.XssModulationInfo}
 */
proto.gw.UplinkTxInfoLegacy.prototype.getXssModulationInfo = function() {
  return /** @type{?proto.gw.XssModulationInfo} */ (
    jspb.Message.getWrapperField(this, proto.gw.XssModulationInfo, 6));
};
 ...
 * @return {!proto.gw.UplinkTxInfoLegacy} returns this
*/
proto.gw.UplinkTxInfoLegacy.prototype.setXssModulationInfo = function(value) {
  return jspb.Message.setOneofWrapperField(this, 6, proto.gw.UplinkTxInfoLegacy.oneofGroups_[0], value);
};
 ...
 * @return {!proto.gw.UplinkTxInfoLegacy} returns this
 */
proto.gw.UplinkTxInfoLegacy.prototype.clearXssModulationInfo = function() {
  return this.setXssModulationInfo(undefined);
};
 ...
 * @return {boolean}
 */
proto.gw.UplinkTxInfoLegacy.prototype.hasXssModulationInfo = function() {
  return jspb.Message.getField(this, 6) != null;
};
 ...
 * @return {!Object}
 */
proto.gw.XssModulationInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.gw.XssModulationInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gw.XssModulationInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gw.XssModulationInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    bandwidth: jspb.Message.getFieldWithDefault(msg, 1, 0),
    spreadingFactor: jspb.Message.getFieldWithDefault(msg, 2, 0),
    codeRateLegacy: jspb.Message.getFieldWithDefault(msg, 3, ""),
 ...
 * @return {!proto.gw.XssModulationInfo}
 */
proto.gw.XssModulationInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gw.XssModulationInfo;
  return proto.gw.XssModulationInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gw.XssModulationInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gw.XssModulationInfo}
 */
proto.gw.XssModulationInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gw.XssModulationInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gw.XssModulationInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gw.XssModulationInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gw.XssModulationInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBandwidth();
  if (f !== 0) {
    writer.writeUint32(
 ...
 * @return {number}
 */
proto.gw.XssModulationInfo.prototype.getBandwidth = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.gw.XssModulationInfo} returns this
 */
proto.gw.XssModulationInfo.prototype.setBandwidth = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.gw.XssModulationInfo.prototype.getSpreadingFactor = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.gw.XssModulationInfo} returns this
 */
proto.gw.XssModulationInfo.prototype.setSpreadingFactor = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.gw.XssModulationInfo.prototype.getCodeRateLegacy = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.gw.XssModulationInfo} returns this
 */
proto.gw.XssModulationInfo.prototype.setCodeRateLegacy = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {!proto.gw.CodeRate}
 */
proto.gw.XssModulationInfo.prototype.getCodeRate = function() {
  return /** @type {!proto.gw.CodeRate} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
 ...
 * @return {!proto.gw.XssModulationInfo} returns this
 */
proto.gw.XssModulationInfo.prototype.setCodeRate = function(value) {
  return jspb.Message.setProto3EnumField(this, 5, value);
};
 ...
 * @return {boolean}
 */
proto.gw.XssModulationInfo.prototype.getPolarizationInversion = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 4, false));
};
 ...
 * @return {!proto.gw.XssModulationInfo} returns this
 */
proto.gw.XssModulationInfo.prototype.setPolarizationInversion = function(value) {
  return jspb.Message.setProto3BooleanField(this, 4, value);
};
 ...
 * @const
 */
proto.gw.DownlinkTxInfoLegacy.oneofGroups_ = [[8,9,17],[13,14,15]];
...
/**
 * optional XssModulationInfo xss_modulation_info = 17;
 * @return {?proto.gw.XssModulationInfo}
 */
proto.gw.DownlinkTxInfoLegacy.prototype.getXssModulationInfo = function() {
  return /** @type{?proto.gw.XssModulationInfo} */ (
    jspb.Message.getWrapperField(this, proto.gw.XssModulationInfo, 17));
};
 ...
 * @return {!proto.gw.DownlinkTxInfoLegacy} returns this
*/
proto.gw.DownlinkTxInfoLegacy.prototype.setXssModulationInfo = function(value) {
  return jspb.Message.setOneofWrapperField(this, 17, proto.gw.DownlinkTxInfoLegacy.oneofGroups_[0], value);
};
 ...
 * @return {!proto.gw.DownlinkTxInfoLegacy} returns this
 */
proto.gw.DownlinkTxInfoLegacy.prototype.clearXssModulationInfo = function() {
  return this.setXssModulationInfo(undefined);
};
 ...
 * @return {boolean}
 */
proto.gw.DownlinkTxInfoLegacy.prototype.hasXssModulationInfo = function() {
 ...
 * @const
 */
proto.gw.ChannelConfiguration.oneofGroups_ = [[3,4,7]];
...
proto.gw.ChannelConfiguration.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    xssModulationConfig: (f = msg.getXssModulationConfig()) && proto.gw.XssModulationConfig.toObject(includeInstance, f),
...
proto.gw.ChannelConfiguration.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      break;
    case 7:
      var value = new proto.gw.XssModulationConfig;
      reader.readMessage(value,proto.gw.XssModulationConfig.deserializeBinaryFromReader);
      msg.setXssModulationConfig(value);
      break;
    case 5:
      var value = /** @type {number} */ (reader.readUint32());
      msg.setBoard(value);
...
proto.gw.ChannelConfiguration.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getXssModulationConfig();
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.gw.XssModulationConfig.serializeBinaryToWriter
    );
  }
  f = message.getBoard();
  if (f !== 0) {
...
/**
 * optional XssModulationConfig xss_modulation_config = 7;
 * @return {?proto.gw.XssModulationConfig}
 */
proto.gw.ChannelConfiguration.prototype.getXssModulationConfig = function() {
  return /** @type{?proto.gw.XssModulationConfig} */ (
    jspb.Message.getWrapperField(this, proto.gw.XssModulationConfig, 7));
};


/**
 * @param {?proto.gw.XssModulationConfig|undefined} value
 * @return {!proto.gw.ChannelConfiguration} returns this
*/
proto.gw.ChannelConfiguration.prototype.setXssModulationConfig = function(value) {
  return jspb.Message.setOneofWrapperField(this, 7, proto.gw.ChannelConfiguration.oneofGroups_[0], value);
};
 ...
 * @return {!proto.gw.ChannelConfiguration} returns this
 */
proto.gw.ChannelConfiguration.prototype.clearXssModulationConfig = function() {
  return this.setXssModulationConfig(undefined);
};
 ...
 * @return {boolean}
 */
proto.gw.ChannelConfiguration.prototype.hasXssModulationConfig = function() {
 ...
 * @const
 */
proto.gw.XssModulationConfig.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.gw.XssModulationConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.gw.XssModulationConfig.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.gw.XssModulationConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gw.XssModulationConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    bandwidthLegacy: jspb.Message.getFieldWithDefault(msg, 1, 0),
    bandwidth: jspb.Message.getFieldWithDefault(msg, 3, 0),
    spreadingFactorsList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f
 ...
 * @return {!proto.gw.XssModulationConfig}
 */
proto.gw.XssModulationConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.gw.XssModulationConfig;
  return proto.gw.XssModulationConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.gw.XssModulationConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.gw.XssModulationConfig}
 */
proto.gw.XssModulationConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.gw.XssModulationConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.gw.XssModulationConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.gw.XssModulationConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.gw.XssModulationConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBandwidthLegacy();
  if (f !== 0) {
    writer.writeUint32(
 ...
 * @return {number}
 */
proto.gw.XssModulationConfig.prototype.getBandwidthLegacy = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.gw.XssModulationConfig} returns this
 */
proto.gw.XssModulationConfig.prototype.setBandwidthLegacy = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.gw.XssModulationConfig.prototype.getBandwidth = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.gw.XssModulationConfig} returns this
 */
proto.gw.XssModulationConfig.prototype.setBandwidth = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {!Array<number>}
 */
proto.gw.XssModulationConfig.prototype.getSpreadingFactorsList = function() {
  return /** @type {!Array<number>} */ (jspb.Message.getRepeatedField(this, 2));
};
 ...
 * @return {!proto.gw.XssModulationConfig} returns this
 */
proto.gw.XssModulationConfig.prototype.setSpreadingFactorsList = function(value) {
  return jspb.Message.setField(this, 2, value || []);
};
 ...
 * @return {!proto.gw.XssModulationConfig} returns this
 */
proto.gw.XssModulationConfig.prototype.addSpreadingFactors = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 2, value, opt_index);
};
 ...
 * @return {!proto.gw.XssModulationConfig} returns this
 */
proto.gw.XssModulationConfig.prototype.clearSpreadingFactorsList = function() {
  return this.setSpreadingFactorsList([]);
};

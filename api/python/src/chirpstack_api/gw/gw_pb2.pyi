...
class Modulation(_message.Message):
    __slots__ = ["lora", "fsk", "lr_fhss", "xss"]
...
class UplinkTxInfoLegacy(_message.Message):
    __slots__ = ["frequency", "modulation", "lora_modulation_info", "fsk_modulation_info", "lr_fhss_modulation_info", "xss_modulation_info"]
...
class UplinkRxInfo(_message.Message):
    __slots__ = ["gateway_id", "uplink_id", "time", "time_since_gps_epoch", "fine_time_since_gps_epoch", "rssi", "snr", "channel", "rf_chain", "board", "antenna", "location", "context", "metadata", "crc_status", "demodulatorID", "IC", "formatID", "esovern0", "frequency", "decodedBurst", "rlCarrierID", "n0", "noisePower", "signalPower", "preFrequency", "tfi"]
    class MetadataEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: _ClassVar[int]
        VALUE_FIELD_NUMBER: _ClassVar[int]
    ...
    METADATA_FIELD_NUMBER: _ClassVar[int]
    CRC_STATUS_FIELD_NUMBER: _ClassVar[int]
    DEMODULATORID_FIELD_NUMBER: _ClassVar[int]
    IC_FIELD_NUMBER: _ClassVar[int]
    FORMATID_FIELD_NUMBER: _ClassVar[int]
    ESOVERN0_FIELD_NUMBER: _ClassVar[int]
    FREQUENCY_FIELD_NUMBER: _ClassVar[int]
    DECODEDBURST_FIELD_NUMBER: _ClassVar[int]
    RLCARRIERID_FIELD_NUMBER: _ClassVar[int]
    N0_FIELD_NUMBER: _ClassVar[int]
    NOISEPOWER_FIELD_NUMBER: _ClassVar[int]
    SIGNALPOWER_FIELD_NUMBER: _ClassVar[int]
    PREFREQUENCY_FIELD_NUMBER: _ClassVar[int]
    TFI_FIELD_NUMBER: _ClassVar[int]
    gateway_id: str
    uplink_id: int
    time: _timestamp_pb2.Timestamp
    time_since_gps_epoch: _duration_pb2.Duration
    ...
    preFrequency: float
    tfi: int
    def __init__(self, gateway_id: _Optional[str] = ..., uplink_id: _Optional[int] = ..., time: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., time_since_gps_epoch: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., fine_time_since_gps_epoch: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ..., rssi: _Optional[int] = ..., snr: _Optional[float] = ..., channel: _Optional[int] = ..., rf_chain: _Optional[int] = ..., board: _Optional[int] = ..., antenna: _Optional[int] = ..., location: _Optional[_Union[_common_pb2.Location, _Mapping]] = ..., context: _Optional[bytes] = ..., metadata: _Optional[_Mapping[str, str]] = ..., crc_status: _Optional[_Union[CRCStatus, str]] = ..., demodulatorID: _Optional[int] = ..., IC: _Optional[int] = ..., formatID: _Optional[str] = ..., esovern0: _Optional[float] = ..., frequency: _Optional[float] = ..., decodedBurst: _Optional[bytes] = ..., rlCarrierID: _Optional[int] = ..., n0: _Optional[float] = ..., noisePower: _Optional[float] = ..., signalPower: _Optional[float] = ..., preFrequency: _Optional[float] = ..., tfi: _Optional[int] = ...) -> None: ...

class DownlinkTxInfoLegacy(_message.Message):
    __slots__ = ["gateway_id", "frequency", "power", "modulation", "lora_modulation_info", "fsk_modulation_info", "xss_modulation_info", "board", "antenna", "timing", "immediately_timing_info", "delay_timing_info", "gps_epoch_timing_info", "context"]
    GATEWAY_ID_FIELD_NUMBER: _ClassVar[int]
    FREQUENCY_FIELD_NUMBER: _ClassVar[int]
...
class ChannelConfiguration(_message.Message):
    __slots__ = ["frequency", "modulation_legacy", "lora_modulation_config", "fsk_modulation_config", "xss_modulation_config", "board", "demodulator"]
    FREQUENCY_FIELD_NUMBER: _ClassVar[int]
